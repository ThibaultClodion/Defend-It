...
public class SpellMelee : MonoBehaviour
{
    public ContactFilter2D collisionFilter;

    //Data coming from Character
    public SpellMeleeData data = null;
    ...
    private int HitTouchedEnnemiesWithRB()
    {
        ...
        int count = rb.Cast(direction, collisionFilter, castCollisions, 1.0f * Time.fixedDeltaTime + collisionOffset);
